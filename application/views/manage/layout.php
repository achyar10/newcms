...
<head>
	...
	<link href="<?php echo media_url('library/font-awesome/css/font-awesome.min.css') ?>" rel="stylesheet">
	<!-- CSS Files -->
						...
						<ul class="navbar-nav">
							<li class="nav-item btn-rotate dropdown">
								<a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									...
									<p>
										<span class="d-lg-none d-md-block"><?php echo $this->session->userdata('ufullname'); ?></span>
									</p>
								</a>
								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
									<a class="dropdown-item" href="<?php echo site_url('manage/profile') ?>">Profile</a>
									<a class="dropdown-item" href="<?php echo site_url('manage/auth/logout?location=' . htmlspecialchars($_SERVER['REQUEST_URI'])) ?>">Logout</a>
								</div>
							</li>
						</ul>
					</div>
