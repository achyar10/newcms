...
abstract class REST_Controller extends CI_Controller {
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        //print_r($this, $controller_method); exit;
        if (! method_exists($this, $controller_method))
        {
            $this->response([
                    $this->config->item('rest_status_field_name') => FALSE,
    ...
    public static function Exception_($e) {
        return array(
            "status" => 'ERROR',
            "code" => ($e->getCode()?$e->getCode():self::HTTP_INTERNAL_SERVER_ERROR),
            "message" => $e->getMessage()
        );
    }
    
    public static function Success_($result) {
        return array(
            "status" => 'OK',
